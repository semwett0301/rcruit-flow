...
export const CV_UPLOAD_ERROR_MESSAGES: Record<CvUploadErrorCode, CvUploadErrorMessage> = {
  [CvUploadErrorCode.INVALID_FILE_TYPE]: {
    ...
    message: `The file you selected is not a supported format. Please upload a file in one of these formats: ${CV_UPLOAD_CONSTRAINTS.ALLOWED_EXTENSIONS.join(', ').toUpperCase()}.`,
 ...
 */
export const getCvUploadErrorMessage = (code: CvUploadErrorCode | string): CvUploadErrorMessage => {
