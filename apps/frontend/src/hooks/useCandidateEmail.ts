/**
 * Custom hook for managing candidate email state and validation.
...
/**
 * Custom hook for managing candidate email state with validation.
 *
...
export const useCandidateEmail = (initialEmail: string): UseCandidateEmailReturn => {
   ...
   * This updates both the current email and the original reference.
   */
